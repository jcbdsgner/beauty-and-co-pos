...
| Dialogue « Un pourboire ? » | `TipDialog` | [`components/comptoir/tip-dialog.tsx`](../components/comptoir/tip-dialog.tsx) — ouvert par « Confirmer l'encaissement » : 9 montants (2k→30k) + « Autre » (clavier), moyen de règlement, « Sans pourboire » ; × revient au Règlement (ADR 0034) |
