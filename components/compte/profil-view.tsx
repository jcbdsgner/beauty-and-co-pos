    ...
    <div className="flex max-w-lg flex-col gap-6">
      <Card className="flex items-center gap-4 p-6">
        ...
        <div className="min-w-0">
          <p className="text-lg font-semibold text-[var(--color-gray-900)]">{currentUser.name}</p>
          <p className="text-sm text-[var(--color-gray-500)]">{ROLE_LABEL[currentUser.role]}</p>
        </div>
      </Card>
      ...
      <div>
        ...
        <p className="font-[family-name:var(--font-heading)] text-xl font-semibold tracking-[0.2em] text-[var(--color-gray-900)]">
          {currentUser.code}
        </p>
