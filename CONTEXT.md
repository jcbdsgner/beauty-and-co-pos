...
**Accueil**:
La section d'atterrissage de l'app : le centre de pilotage du jour — la section **« Rendez-vous »** (grille fixe de 3 cartes, une par réservation, triée par heure, chacune avec « Encaisser » — reflet de la **vue journée** « Le jour » partagée avec le Planning, ADR 0014/0018), cartes cadeaux à imprimer. Chaque carte porte la **composition** du passage (« 1 femme + 1 enfant », « 2 femmes »…, ADR 0018) plutôt qu'un résumé des prestations, et ne grossit jamais : au-delà de 3 lignes (prestations puis extras — boisson, produit pré-commandé à emporter), le reste se résume en « + N de plus », le détail complet vivant dans la fiche réservation. Son en-tête porte aussi un accès **« Créer un rendez-vous »** vers la plateforme de réservation externe (la prise de rendez-vous ne vit pas dans l'app, ADR 0006/0009) — utile quand une cliente veut réserver par téléphone. Porté le nom **Journée** pendant la refonte v2 du userflow, revenu à **Accueil**. Ne ressuscite pas le verbe **Accueillir** (retiré — voir Encaisser) : la section s'appelle Accueil, le geste au comptoir reste « Encaisser ». Coexiste avec le rôle « Accueil » de la vue Équipe (la fonction de la personne au comptoir) — même mot, contextes distincts (item de navigation vs filtre de rôle).
