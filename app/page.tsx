...
import { ComptoirPanel } from "@/components/ui/organisms/comptoir-panel";
  ...
  return (
    <TooltipProvider>
      <div className="min-h-screen bg-[var(--brand-cream)]">
        <div className="mx-auto flex max-w-6xl flex-col gap-12 px-8 py-8 pb-24">
          <PageHeader
            title="Composants"
          ...
          <section id="comptoir" className="flex flex-col gap-6 scroll-mt-20">
            ...
            {comptoirOpen && (
              <div className="max-w-sm">
                <FieldLabel className="mb-2">ComptoirPanel</FieldLabel>
                <ComptoirPanel
                  title="Panier (3)"
                  footer={
                    <>
